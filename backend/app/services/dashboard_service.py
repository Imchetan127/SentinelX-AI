...
class DashboardService:
    ...
    def get_metrics(self) -> Dict[str, Any]:
        ...
        # 14. Audit logs for timeline (latest 15)
        ...
        for log in recent_logs:
            ...
            recent_activity_timeline.append({
                "time": log.timestamp.strftime("%H:%M:%S") if log.timestamp else "00:00:00",
        ...
        if not recent_activity_timeline:
            recent_activity_timeline = [
                {"time": "00:00:00", "event": "System initialized and AI Blue Team monitoring online", "severity": "Info"}
            ]

        # Calculations
        threats_detected = detections_performed
        threats_blocked = max(0, threats_detected - active_incidents)
